...
inventory_metrics AS (
    SELECT
        ...
        SUM(CASE WHEN lcm.MRP_CATEGORY IN ('Warehouse', 'Receiving & Pre-IQC') THEN inv.${inventory_quantity_column} * COALESCE(pv.PRODUCT_VALUE, 0) ELSE 0 END) AS "Current On-Hand Inventory Value",
    ...
    LEFT JOIN product_values pv
        ON pv.PART_NUMBER = inv.${inventory_part_number_column}
